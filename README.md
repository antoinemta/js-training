[![Build Status](https://travis-ci.org/antoinemta/js-training.svg?branch=master)](https://travis-ci.org/antoinemta/js-training)
## Setup
First, [**fork**](https://github.com/antoinemta/js-training/fork?fragment=1) this repository.
